...
const marketingQuotes = [
  ...
  { text: "Make your customer the hero of your story.", author: "Ann Handley" },
  { text: "The aim of marketing is to know the customer so well that the product sells itself.", author: "Peter Drucker" },
  { text: "Your most unhappy customers are your greatest source of learning.", author: "Bill Gates" },
  { text: "The best sale is built on the relationship between buyer and seller.", author: "Jeffrey Gitomer" },
];

// Dopamine-triggering micro-achievements
const microAchievements = [
  "Form completion boosts sales potential by 35%!",
  "Great detail! Your conversion rate just increased!",
  "You're creating a sales campaign better than 85% of marketers!",
  "Excellent progress! Your strategy is shaping up nicely!",
  "Amazing offers! Your customers will love these deals!",
  "You're unlocking premium sales potential!"
];
...
function DriveSales() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error creating sales campaign:', err);
      ...
      <div className="content-wrapper">
        ...
        <div className="form-section" ref={formRef}>
          <div className="form-header">
            <h2 className="title-glow">Drive Sales</h2>
            <p className="subtitle">
              Accelerate your sales efforts and push for higher conversion rates. Provide
          ...
          {isCreating && (
            <div className="creating-notification">
              ...
              <p>Creating your sales campaign magic, enjoy the mini-game while you wait...</p>
            </div>
          )}
          ...
          <form className="amplify-form" onSubmit={handleSubmit}>
            ...
            <div className={`form-group floating-label ${activeField === 'productService' ? 'active-field' : ''}`}>
              <textarea
                name="productService"
                rows="2"
                placeholder=" "
                ...
                onChange={handleChange}
                className={formData.productService ? 'field-filled' : ''}
                onFocus={() => setActiveField('productService')}
                onBlur={() => setActiveField(null)}
              />
            ...
            <div className={`form-group floating-label ${activeField === 'promotionalOffers' ? 'active-field' : ''}`}>
              <textarea
                ...
                onChange={handleChange}
                className={formData.promotionalOffers ? 'field-filled' : ''}
                onFocus={() => setActiveField('promotionalOffers')}
                onBlur={() => setActiveField(null)}
              />
            ...
            <div className={`form-group floating-label ${activeField === 'targetLocations' ? 'active-field' : ''}`}>
              <select
                name="targetLocations"
                value={formData.targetLocations}
                onChange={handleChange}
                className={formData.targetLocations ? 'field-filled' : ''}
                onFocus={() => setActiveField('targetLocations')}
                onBlur={() => setActiveField(null)}
              >
                <option value=""></option>
          ...
          <div className="brand-network-card" ref={networkRef}>
            ...
            <div className="overlay-content">
              <div className="overlay-header">
                <h3>Sales Network Visualizer</h3>
                <p>Watch your sales connections evolve as you build your campaign</p>
              </div>
              
              {isCreating && (
                <div className="creating-animation">
                  <div className="processing-text">Building Your Sales Campaign</div>
                  ...
                  <div className="processing-subtext">Analyzing sales touchpoints...</div>
                </div>
              )}
              ...
              <div className="brand-metrics">
                ...
                <div className="metrics-row">
                  <div className="metric-item">
                    ...
                    <div className="metric-label">Sales Connections</div>
                    <div className="metric-bar">
                      <div 
                  ...
                  <div className="metric-item">
                    ...
                    <div className="metric-label">Conversion Potential</div>
                    <div className="metric-bar">
                      <div 
                        className="metric-fill" 
            ...
            <div className="engagement-card">
              ...
              <div className="platform-effectiveness">
                ...
                <div className="platform-bars">
                  ...
                  <div className="platform-item">
                    <div className="platform-name">E-commerce</div>
                    <div className="platform-bar-container">
                      <div 
                        className="platform-bar" 
      ...
      {showSuccessPopup && (
        <div className="success-popup">
          ...
          <div className="success-content">
            ...
            <h3>Sales Campaign Successfully Created!</h3>
            <p>Preparing your sales acceleration strategy...</p>
