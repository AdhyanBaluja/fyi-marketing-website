...
const marketingQuotes = [
  { text: "Your next customer is someone who doesn't even know you exist yet.", author: "Steve Blank" },
  { text: "Business is not just about doing deals; business is about having great products and doing great engineering.", author: "Elon Musk" },
  { text: "Markets change, tastes change, so the companies and the individuals who choose to compete in those markets must change.", author: "Philip Kotler" },
  { text: "Your most unhappy customers are your greatest source of learning.", author: "Bill Gates" },
  { text: "If you're competitor-focused, you have to wait until there is a competitor doing something. Being customer-focused allows you to be more pioneering.", author: "Jeff Bezos" },
  ...
  { text: "The key is to set realistic customer expectations, and then not to just meet them, but to exceed them.", author: "Richard Branson" },
];

// Dopamine-triggering micro-achievements
const microAchievements = [
  "Form completion boosts customer reach by 40%!",
  "Great detail! Your customer acquisition potential just increased!",
  "You're creating a campaign better than 80% of marketers!",
  "Excellent progress! Your acquisition strategy is shaping up nicely!",
  "Amazing approach! New customers will be drawn to your offer!",
  "You're unlocking premium customer acquisition potential!"
];
...
function FindNewCustomers() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error creating customer acquisition campaign:', err);
      ...
      <div className="content-wrapper">
        ...
        <div className="form-section" ref={formRef}>
          <div className="form-header">
            <h2 className="title-glow">Find New Customers</h2>
            <p className="subtitle">
              Reach untapped markets and expand your customer base. Provide details below to
          ...
          {isCreating && (
            <div className="creating-notification">
              ...
              <p>Creating your customer acquisition campaign, enjoy the mini-game while you wait...</p>
            </div>
          )}
          ...
          <form className="amplify-form" onSubmit={handleSubmit}>
            ...
            <div className={`form-group floating-label ${activeField === 'newSegments' ? 'active-field' : ''}`}>
              <textarea
                name="newSegments"
                rows="2"
                placeholder=" "
                ...
                onChange={handleChange}
                className={formData.newSegments ? 'field-filled' : ''}
                onFocus={() => setActiveField('newSegments')}
                onBlur={() => setActiveField(null)}
              />
            ...
            <div className={`form-group floating-label ${activeField === 'valueProposition' ? 'active-field' : ''}`}>
              <textarea
                ...
                onChange={handleChange}
                className={formData.valueProposition ? 'field-filled' : ''}
                onFocus={() => setActiveField('valueProposition')}
                onBlur={() => setActiveField(null)}
              />
          ...
          <div className="brand-network-card" ref={networkRef}>
            ...
            <div className="overlay-content">
              <div className="overlay-header">
                <h3>Customer Acquisition Visualizer</h3>
                <p>Watch your customer networks evolve as you build your campaign</p>
              </div>
              
              {isCreating && (
                <div className="creating-animation">
                  <div className="processing-text">Building Your Acquisition Campaign</div>
                  ...
                  <div className="processing-subtext">Analyzing new market opportunities...</div>
                </div>
              )}
              ...
              <div className="brand-metrics">
                ...
                <div className="metrics-row">
                  <div className="metric-item">
                    ...
                    <div className="metric-label">Market Connections</div>
                    <div className="metric-bar">
                      <div 
                  ...
                  <div className="metric-item">
                    ...
                    <div className="metric-label">Acquisition Potential</div>
                    <div className="metric-bar">
                      <div 
                        className="metric-fill" 
          ...
          <div className="interactive-section">
            <div className="quote-card">
              <div className="quote-header">
                <h4>Customer Acquisition Wisdom</h4>
            ...
            <div className="engagement-card">
              ...
              <div className="platform-effectiveness">
                ...
                <div className="platform-bars">
                  ...
                  <div className="platform-item">
                    <div className="platform-name">Content Marketing</div>
                    <div className="platform-bar-container">
                      <div 
                        className="platform-bar" 
            ...
            <div className="impact-simulator">
              <div className="impact-header">
                <h4>Customer Reach Simulator</h4>
      ...
      {showSuccessPopup && (
        <div className="success-popup">
          ...
          <div className="success-content">
            ...
            <h3>Acquisition Campaign Successfully Created!</h3>
            <p>Preparing your customer acquisition strategy...</p>
